...
#wraps code cells, start implementing this for knitted PDF's
#when knitting a doc, DO NOT have install packages in code, PUT A # in front of it
...
```{r, message = FALSE}
getwd()
setwd("/home/guest/EDA-Fall2022/EDA-Fall2022")
...
> Answer: row numb is arbitrary

## Pipes (shortcut: shift + ctrl + m)
...
#highlight and press ctrl + f1 for help!!!!
