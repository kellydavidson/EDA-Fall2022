...
vector1[3] # how to select a value within the vector
vector1[3:5] # how to select multiple values within the vector

# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # define number of rows and number of columns
matrix1
...
e <- c("red", "white", "red", NA) # What type of vector? NA is a placeholder
f <- c(TRUE, TRUE, TRUE, FALSE) # What type of vector?
dataframe1 <- data.frame(d,e,f) #
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # override column names, names and colnames are the same

dataframe1[1:2,] # 
dataframe1[c("ID","Passed")] # referring to columns by names
dataframe1$ID
...
tempdataframe <- data.frame(vectorhigh, vectorlow, celhigh, cellow)
tempdataframe
...
# today will tell you today's date
today <- Sys.Date()
