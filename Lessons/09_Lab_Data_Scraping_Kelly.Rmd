...
#Get the data, which starts on line 30 - use read.table because data is separated by tab
gage_data <- read.table(theURL,skip = 29,header=TRUE,sep='\t',stringsAsFactors = T) 
#skip = 29 because the first 29 lines are just text, not the data
...
#Identify gauge site to download
siteNo <- '02087500' 

#Identify parameter of interest: 
pcode = '00060' #discharge (cfs) - this is the parameter code
...
#Rename columns to something more useful - these have already been defined for us within the data retrevial package
...
nc_pop <- 
  get_acs(geography = "county",
          variables = "B01003_001", #this is the code for total population of counties
          state = "NC",
          geometry = TRUE)
...
df_manyyears <- map(seq(2017,2019), scrape.it)
