...
### My Git settings:
user.name=kellydavidson
user.email=kmd110@duke.edu

### My Git remote settings:
origin  https://github.com/kellydavidson/EDA-Fall2022 (fetch)
origin  https://github.com/kellydavidson/EDA-Fall2022 (push)
upstream        https://github.com/ENV872/EDA-Fall2022 (fetch)
upstream        DISABLE (push)

### My Git changes:
8b867fa (HEAD -> main, origin/main, origin/HEAD) Put assignment 1 in folder
