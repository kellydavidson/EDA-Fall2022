...
```{r}
# 6.
vector1 <- student_names <- c("Ashley" , "Brad" , "Claire" , "Dave")  #character
vector2 <- test_scores <- c(98, 72 , 49 , 61)  #integer
vector3 <- pass_fail <- c(TRUE , TRUE , FALSE , TRUE)  #logical

#7.
data_frame(vector1, vector2, vector3)
