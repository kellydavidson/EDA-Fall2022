...
>ANSWER: A new column 'geometry' is included in the sf dataframe which is created from the 'dec_long_va' and 'dec_lat_va' columns, both of which are no longer included in the sf dataframe.
...
ggplot() +
  ...
  ggtitle("NWIS Gage Locations in Nebraska", subtitle = "Kelly Davidson")
...
mapView(Gage_data_join_sf, zcol = "gage_ht") + mapView(NE_counties_sf, col.regions = "light grey")
...
#24. Plot
mapView(Lancaster_intersect, col.regions = "red") + mapView(Lancaster_county, col.regions = "blue") + mapView(NE_counties_utm, col.regions = "light yellow")
