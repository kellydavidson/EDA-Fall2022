...
phosphate_plot <-
  ...
  geom_abline() + #adding line of best fit
  ylim(0, 200) #adjusting y-axis to hide extreme values above 200
...
temp_boxplot <-
  ggplot(Lake_nutrients_processed, aes(x = month)) +
  geom_boxplot(aes(color = lakename))

print(temp_TP_TN_boxplot)
